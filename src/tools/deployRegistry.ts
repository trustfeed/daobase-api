...
const campaignRegistryBuffer: Buffer = fs.readFileSync('contracts/TrustFeedCampaignRegistry.json');
const contractData = JSON.parse(campaignRegistryBuffer.toString());
const web3 = web3OnNetwork(process.argv[2]);
